class AccountsController < ApplicationController
  ...
  def index
    ...
    @gocardless_items = visible_provider_items(family.gocardless_items.active.ordered.includes(:gocardless_accounts, :accounts))
    @powens_items = visible_provider_items(family.powens_items.active.ordered.includes(:powens_accounts, :accounts))
